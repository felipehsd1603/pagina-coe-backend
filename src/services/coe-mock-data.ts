...
export const MOCK_COE_APPS: CoeApp[] = [
  {
    ...
    admin_appenvironment: 'Producao - Empresa Ficticia Saneamento',
    admin_appowner: 'Carlos Silva',
    admin_appowneremail: 'carlos.silva@empresa-ficticia.com.br',
  ...
  },
  {
    ...
    admin_appowneremail: 'ana.oliveira@empresa-ficticia.com.br',
    admin_apptype: 'CanvasApp',
  ...
  },
  {
    ...
    admin_appowneremail: 'roberto.santos@empresa-ficticia.com.br',
    admin_apptype: 'CanvasApp',
  ...
  },
  {
    ...
    admin_appowneremail: 'fernanda.lima@empresa-ficticia.com.br',
    admin_apptype: 'CanvasApp',
  ...
  },
  {
    ...
    admin_appowneremail: 'marcos.pereira@empresa-ficticia.com.br',
    admin_apptype: 'CanvasApp',
  ...
  },
  {
    ...
    admin_appowneremail: 'juliana.costa@empresa-ficticia.com.br',
  ...
  },
  {
    ...
    admin_appowneremail: 'paulo.mendes@empresa-ficticia.com.br',
    admin_apptype: 'CanvasApp',
    admin_appregional: 'Corporativo',
  ...
  },
  {
    ...
    admin_appowneremail: 'diego.almeida@empresa-ficticia.com.br',
    admin_apptype: 'CanvasApp',
  ...
  },
  {
    ...
    admin_appowneremail: 'luciana.barbosa@empresa-ficticia.com.br',
    admin_apptype: 'CanvasApp',
  ...
  },
  {
    ...
    admin_appowneremail: 'ricardo.ferreira@empresa-ficticia.com.br',
    admin_apptype: 'ModelDrivenApp',
    admin_appregional: 'Aguas do Rio de Janeiro',
...
export const MOCK_COE_FLOWS: CoeFlow[] = [
  {
    ...
    admin_flowenvironment: 'Producao - Empresa Ficticia Saneamento',
    admin_flowowner: 'Carlos Silva',
    admin_flowowneremail: 'carlos.silva@empresa-ficticia.com.br',
  ...
  },
  {
    ...
    admin_flowowneremail: 'paulo.mendes@empresa-ficticia.com.br',
    admin_flowstate: 'Started',
    admin_flowtype: 'Automated',
  ...
  },
  {
    ...
    admin_flowowneremail: 'marcos.pereira@empresa-ficticia.com.br',
    admin_flowstate: 'Started',
  ...
  },
  {
    ...
    admin_flowowneremail: 'ana.oliveira@empresa-ficticia.com.br',
    admin_flowstate: 'Started',
    admin_flowtype: 'Automated',
    admin_triggertype: 'Dataverse - When a row is added',
  ...
  },
  {
    ...
    admin_flowowneremail: 'roberto.santos@empresa-ficticia.com.br',
    admin_flowstate: 'Started',
    admin_flowtype: 'Scheduled',
...
export const MOCK_COE_MAKERS: CoeMaker[] = [
  { admin_makerid: 'maker-001', admin_displayname: 'Carlos Silva', admin_useremail: 'carlos.silva@empresa-ficticia.com.br', admin_department: 'Engenharia', admin_city: 'Rio de Janeiro', admin_appscount: 3, admin_flowscount: 5, admin_lastactivedate: '2026-03-19T14:00:00Z' },
  { admin_makerid: 'maker-002', admin_displayname: 'Ana Oliveira', admin_useremail: 'ana.oliveira@empresa-ficticia.com.br', admin_department: 'Operacoes', admin_city: 'Teresina', admin_appscount: 2, admin_flowscount: 4, admin_lastactivedate: '2026-03-20T09:00:00Z' },
  { admin_makerid: 'maker-003', admin_displayname: 'Roberto Santos', admin_useremail: 'roberto.santos@empresa-ficticia.com.br', admin_department: 'Seguranca', admin_city: 'Manaus', admin_appscount: 1, admin_flowscount: 2, admin_lastactivedate: '2026-03-18T11:00:00Z' },
  { admin_makerid: 'maker-004', admin_displayname: 'Fernanda Lima', admin_useremail: 'fernanda.lima@empresa-ficticia.com.br', admin_department: 'Logistica', admin_city: 'Campo Grande', admin_appscount: 2, admin_flowscount: 3, admin_lastactivedate: '2026-03-19T16:00:00Z' },
  { admin_makerid: 'maker-005', admin_displayname: 'Marcos Pereira', admin_useremail: 'marcos.pereira@empresa-ficticia.com.br', admin_department: 'Qualidade', admin_city: 'Porto Alegre', admin_appscount: 4, admin_flowscount: 7, admin_lastactivedate: '2026-03-20T07:00:00Z' },
  { admin_makerid: 'maker-006', admin_displayname: 'Juliana Costa', admin_useremail: 'juliana.costa@empresa-ficticia.com.br', admin_department: 'RH', admin_city: 'Sao Paulo', admin_appscount: 1, admin_flowscount: 2, admin_lastactivedate: '2026-03-20T10:00:00Z' },
  { admin_makerid: 'maker-007', admin_displayname: 'Paulo Mendes', admin_useremail: 'paulo.mendes@empresa-ficticia.com.br', admin_department: 'Financeiro', admin_city: 'Sao Paulo', admin_appscount: 2, admin_flowscount: 6, admin_lastactivedate: '2026-03-19T14:00:00Z' },
  { admin_makerid: 'maker-008', admin_displayname: 'Diego Almeida', admin_useremail: 'diego.almeida@empresa-ficticia.com.br', admin_department: 'Operacoes', admin_city: 'Timon', admin_appscount: 1, admin_flowscount: 1, admin_lastactivedate: '2026-03-18T08:00:00Z' },
  { admin_makerid: 'maker-009', admin_displayname: 'Luciana Barbosa', admin_useremail: 'luciana.barbosa@empresa-ficticia.com.br', admin_department: 'Operacoes', admin_city: 'Sinop', admin_appscount: 2, admin_flowscount: 3, admin_lastactivedate: '2026-03-20T06:00:00Z' },
  { admin_makerid: 'maker-010', admin_displayname: 'Ricardo Ferreira', admin_useremail: 'ricardo.ferreira@empresa-ficticia.com.br', admin_department: 'Financeiro', admin_city: 'Rio de Janeiro', admin_appscount: 1, admin_flowscount: 2, admin_lastactivedate: '2026-03-19T11:00:00Z' },
];
...
export const MOCK_COE_ENVIRONMENTS: CoeEnvironment[] = [
  { admin_environmentid: 'env-001', admin_displayname: 'Producao - Empresa Ficticia Saneamento', admin_environmenttype: 'Production', admin_region: 'Brazil', admin_appscount: 42, admin_flowscount: 85, admin_makerscount: 120, admin_createdon: '2023-01-15T08:00:00Z' },
  { admin_environmentid: 'env-002', admin_displayname: 'Homologacao - Empresa Ficticia', admin_environmenttype: 'Sandbox', admin_region: 'Brazil', admin_appscount: 28, admin_flowscount: 45, admin_makerscount: 35, admin_createdon: '2023-03-01T10:00:00Z' },
