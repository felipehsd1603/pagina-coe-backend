  ...
  const apps = await Promise.all([
    prisma.app.create({
      data: {
        ...
        slug: 'pipaea',
        description:
          'Plataforma integrada de acompanhamento de execucao da EMPRESA_FICTICIA. Permite o monitoramento em tempo real de indicadores operacionais, metas e planos de acao das concessionarias.',
        ...
        ownerEmail: 'excelencia@empresa-ficticia.com.br',
    ...
    prisma.app.create({
      data: {
        ...
        ownerEmail: 'administrativo@empresa-ficticia.com.br',
        regional: 'Corporativo',
        environment: 'Default-8991054c-e987-4297-a373-f9cf0e0c47ec',
        usersCount: 85,
        sessionsMonth: 1200,
    ...
    prisma.app.create({
      data: {
        ...
        ownerEmail: 'qualidade@empresa-ficticia.com.br',
        regional: 'Todas',
        environment: 'Default-8991054c-e987-4297-a373-f9cf0e0c47ec',
        usersCount: 200,
        sessionsMonth: 5600,
    ...
    prisma.app.create({
      data: {
        ...
        ownerEmail: 'engenharia@empresa-ficticia.com.br',
        regional: 'Corporativo',
        environment: 'Default-8991054c-e987-4297-a373-f9cf0e0c47ec',
        usersCount: 35,
        sessionsMonth: 280,
    ...
    prisma.app.create({
      data: {
        ...
        ownerEmail: 'compras@empresa-ficticia.com.br',
        regional: 'Corporativo',
        usersCount: 42,
        sessionsMonth: 380,
        benefits: {
    ...
    prisma.app.create({
      data: {
        ...
        ownerEmail: 'rh@empresa-ficticia.com.br',
        regional: 'Corporativo',
        usersCount: 0,
        sessionsMonth: 0,
        benefits: {
    ...
    prisma.app.create({
      data: {
        ...
        ownerEmail: 'meioambiente@empresa-ficticia.com.br',
        regional: 'Corporativo',
        usersCount: 0,
        sessionsMonth: 0,
      },
    ...
    prisma.app.create({
      data: {
        ...
        ownerEmail: 'comercial@empresa-ficticia.com.br',
        regional: 'Todas',
        environment: 'Default-8991054c-e987-4297-a373-f9cf0e0c47ec',
        usersCount: 150,
        sessionsMonth: 18000,
  ...
  const demands = await Promise.all([
    prisma.demand.create({
      data: {
        ...
        requesterEmail: 'paulo.ferreira@empresa-ficticia.com.br',
    ...
    prisma.demand.create({
      data: {
        ...
        requesterEmail: 'lucia.barbosa@empresa-ficticia.com.br',
        area: 'Comercial',
        priority: 'MEDIUM',
        status: 'PENDING',
      },
